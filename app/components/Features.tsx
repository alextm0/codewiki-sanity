        ...
        >
          ...
          <div className="flex items-center space-x-5 my-5 pr-8 md:pr-0">
            ...
            <p className="text-text-600 dark:text-text-300">
              ...
              <br />
              Toate materialele sunt realizate de fosti olimpici și sunt testate
              riguros. Vei învăța cu lecții clare și exemple practice care te
              vor ajuta să înțelegi conceptele complexe.
            </p>
          </div>
          <div className="flex items-center space-x-5 my-5 pr-8 md:pr-0">
            <div className="flex-shrink bg-background-50 dark:bg-background-800 shadow-lg rounded-full p-3 flex items-center justify-center">
            ...
            <p className="text-text-600 dark:text-text-300">
              ...
              pentru soluțiile tale, astfel încât să îți îmbunătățești continuu
              performanța.
            </p>
          </div>
        </div>
