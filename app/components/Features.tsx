    ...
    <>
      <div className="md:flex my-16 md:space-x-10 items-center font-inter">
        <div data-aos="fade-right" data-aos-delay="300" className="md:w-7/12 relative">
          <Image className='w-[750px] h-full relative z-50 floating ml-auto mr-auto my-44' src={CodeImg} alt="codeimg" />
        </div>
        <div data-aos="fade-right" data-aos-delay="350" className="sm:max-w-[500px] md:w-3/12 -mt-20 mb-40 sm:mt-20 sm:mb-0 ml-6 md:ml-0 md:mt-0 text-text-900 dark:text-text-100">
          <div className="flex items-center space-x-5 my-5 pr-8 md:pr-0">
          ...
          <div className="flex items-center space-x-5 my-5 pr-8 md:pr-0">
            ...
            <p className='text-text-600 dark:text-text-300'>
              <span className='text-secondary-500 font-bold'>Calitatea conținutului</span>  <br />
          ...
          <div className="flex items-center space-x-5 my-5 pr-8 md:pr-0">
            ...
            <p className='text-text-600 dark:text-text-300'>
              <span className='text-secondary-500 font-bold'>Feedback și suport</span> < br/>
